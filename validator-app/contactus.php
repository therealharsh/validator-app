...
?>
		<?php
			if($counter >0){
			echo"<title>($counter) Contact Us - RatsValidator</title>";
			}
			else{
			echo"<title>Contact Us - RatsValidator</title>";
			}
		?>
...
html{
  /** Basic styles for an animated element */
	...
	?>
			...
			<div id="flip"><p>Contact Us</p></div>
			<div id="panel">
			...
			<input type="text" id="fname" name="fname" placeholder="Name"><br>
				...
				<textarea type="text" name="name" id="name" maxlength="400" placeholder="What would you like to say?" rows="20%" 			cols="100%" form="createPost" required></textarea><br>
