...
?>
		<?php
			if($counter >0){
			echo"<title>($counter) Create Chatname - RatsValidator</title>";
			}
			else{
			echo"<title>Create Chatname - RatsValidator</title>";
			}
		?>
  ...
  /** Basic styles for an animated element */
	...
	<?php if(!isset($_COOKIE['uratsvalidator'])){exit;} ?>
		<div id="page">
			...
			<div id="flip"><p>Create New Chatname</p></div>
			<div id="panel">
			...
			<h5><center>Create a chatname: (beeteedubs: People you start conversations with can see this)</center></h5>
			<form id="createPost" method="post" action="chatnamescript.php">
				<input type="chatname" id="pass" name="chatname" placeholder="Chatname eg: fatboy123"><br>
